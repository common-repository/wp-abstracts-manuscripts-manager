...
if($event_id && !wpabstracts_is_event_active($event_id)){
	wpabstracts_show_message(__('Abstract submission for this event has passed', 'wpabstracts'), 'alert-danger');
	return;
}
					...
					<div class="wpabstracts panel-body">
						...
						<?php if (get_option('wpabstracts_show_description')) { ?>
							<div class="wpabstracts form-group">
								...
								$settings = array( 'editor_id' => 'abstext', 'media_buttons' => $editorMedia, 'wpautop'=>true, 'dfw' => true, 'editor_height' => 360, 'quicktags' => true);?>
					...
					<div class="wpabstracts panel-body">
						...
						<div class="wpabstracts form-group">
							<?php if(!$event_id){ ?>
								...
								<div class="wpabstracts form-group">
									<label class="wpabstracts control-label" for="topic_id"><?php echo apply_filters('wpabstracts_title_filter', __('Topic','wpabstracts'), 'topic');?></label>
							...
							<?php } else { ?>
								...
								<div class="wpabstracts form-group">
									...
									<select name="topic_id" id="topic_id" class="wpabstracts form-control wpa_event_input">
										<option value="" style="display:none;"><?php echo apply_filters('wpabstracts_title_filter', __('Select a Topic','wpabstracts'), 'select_topic');?></option>
										<?php $topics = wpabstracts_get_topics($event_id);?>
