		...
		<div class="wpabstracts panel panel-default">
			...
			<div class="wpabstracts panel panel-body">
				<div class="wpabstracts form-group col-md-4 col-xs-12">
					...
					<input type="text" name="email" id="email" required class="wpabstracts form-control" placeholder="Email">
				...
				<div class="wpabstracts form-group col-md-4 col-xs-12">
					...
					<input type="password" name="password" id="password" required autocomplete="off" class="wpabstracts form-control" placeholder="Password">
				...
				<div class="wpabstracts form-group col-md-4 col-xs-12">
					...
					<input type="password" name="password_repeat" required id="password_repeat" class="wpabstracts form-control" placeholder="Repeat Password">
