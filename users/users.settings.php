...
function wpabstracts_save_option() {
	...
	$formOptions->redirect_after = intval($_POST['redirect_after']);
	$formOptions->redirect_url = wp_kses_post($_POST['redirect_url']);

	$formOptions->admin_email_on = intval($_POST['admin_email_on']);
	$formOptions->admin_from_name = sanitize_text_field($_POST['admin_from_name']);
	$formOptions->admin_from_email = strtolower(sanitize_email($_POST['admin_from_email']));
	$formOptions->admin_email_subject = sanitize_text_field($_POST['admin_email_subject']);
	$formOptions->admin_reg_email = wp_kses_post($_POST['admin_reg_email']);
	...
	foreach($userlist_columns as $field_name){
		$field = wpabstracts_get_user_field_record($form_fields, $field_name);
...
function wpabstracts_is_column_selected($field_name, $columns){
	if(is_array($columns) && property_exists((object)$columns, $field_name)){
	...
	<form method="post" id="wpabstracts_settings" action="?page=wpabstracts&tab=users&subtab=settings">
				...
				<div class="wpabstracts panel panel-primary">
					...
					<div class="wpabstracts panel-body">
						...
						<div class="wpabstracts form-group col-xs-12">
							...
							<select name="reg_message_on" class="wpabstracts pull-right">
						...
						<div class="wpabstracts form-group col-xs-12">
							...
							<select name="reg_email_on" class="wpabstracts pull-right">
						...
						<div class="wpabstracts form-group col-xs-12">
							<label class="wpabstracts control-label"><?php _e('Notify Admin on User Registration', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Set whether to send an email to admins when a user registers. Ps. Wordpress also does this.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<select name="admin_email_on" class="wpabstracts pull-right">
								<option value="1" <?php selected($settings->admin_email_on, 1); ?>><?php _e('Yes', 'wpabstracts'); ?></option>
								<option value="0"  <?php selected($settings->admin_email_on, 0); ?>><?php _e('No', 'wpabstracts'); ?></option>
							</select>
						</div>
						...
						<div class="wpabstracts form-group col-xs-12">
							...
							<select name="auto_activate_on" class="wpabstracts pull-right">
						...
						<div class="wpabstracts form-group col-xs-12">
							...
							<select name="ignore_activation" class="wpabstracts pull-right">
						...
						<div class="wpabstracts form-group col-xs-12">
							...
							<select class="wpabstracts pull-right" name="sync_fields">
						...
						<div class="wpabstracts form-group col-xs-12">
							<label class="wpabstracts control-label"><?php _e('Wordpress Display Name', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Select the field or fields you would like to use as Wordpress display name for all users.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<?php $form_fields = json_decode(get_option('wpabstracts_registration_form')); ?>
							<select name="display_name" class="wpabstracts pull-right">
								<?php 
						...
						<div class="wpabstracts form-group col-xs-12">
							<label class="wpabstracts control-label"><?php _e('Redirect User after Registration', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Set the time (in seconds) to redirect the user to a specific page after registration.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<select name="redirect_after" class="wpabstracts pull-right">
								<option value="5" <?php selected($settings->redirect_after ?? null, 5); ?>><?php _e('5 seconds', 'wpabstracts'); ?></option>
								<option value="10" <?php selected($settings->redirect_after ?? null, 10); ?>><?php _e('10 seconds', 'wpabstracts'); ?></option>
								<option value="30" <?php selected($settings->redirect_after ?? null, 30); ?>><?php _e('30 seconds', 'wpabstracts'); ?></option>
								<option value="0" <?php selected($settings->redirect_after ?? null, 0); ?>><?php _e('Disabled', 'wpabstracts'); ?></option>
							</select>
						</div>

						<div class="wpabstracts form-group col-xs-12">
							<label class="wpabstracts control-label"><?php _e('Redirection URL', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Set the URL to redirect the user after registration.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<input class="wpabstracts form-control" name="redirect_url" type="text" value="<?php echo $settings->redirect_url ?? ""; ?>" />
						</div>
		...
		<div class="wpabstracts row">
			...
			<div class="wpabstracts col-xs-12">
				<div class="wpabstracts panel panel-primary">
					...
					<div class="wpabstracts panel-body">
						<div class="wpabstracts form-group col-xs-12">
							<?php
							$tuSettings = array( 'media_buttons' => false, 'textarea_name' => 'reg_message', 'wpautop'=>true, 'dfw' => true, 'editor_height' => 100, 'quicktags' => true);
				...
				<div class="wpabstracts panel panel-primary">
					...
					<div class="wpabstracts panel-body">
						...
						<div class="wpabstracts form-group col-xs-12 col-md-4">
							...
							<span class="settings_tip" data-tip="<?php _e('Enter a From name for the email to the newly registered user.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
						...
						<div class="wpabstracts form-group col-xs-12 col-md-4">
							...
							<span class="settings_tip" data-tip="<?php _e('Enter a From email address for the email to the newly registered user.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
			...
			<div class="wpabstracts col-xs-12">
				<div class="wpabstracts panel panel-primary">
					<div class="wpabstracts panel-heading">
						<h6 class="wpabstracts panel-title"><?php _e('Admin Notification', 'wpabstracts'); ?>
							<span class="settings_tip" data-tip="<?php _e('Create an email template used for sending a notification to admins when a new user registers.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
						</h6>
					</div>
					<div class="wpabstracts panel-body">
						...
						<div class="wpabstracts form-group col-xs-12 col-md-4">
							<label class="wpabstracts control-label"><?php _e('From Name', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Enter a From name for your notification.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<input class="wpabstracts form-control" name="admin_from_name" type="text" value="<?php echo $settings->admin_from_name; ?>" />
						</div>

						<div class="wpabstracts form-group col-xs-12 col-md-4">
							<label class="wpabstracts control-label"><?php _e('From Email', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Enter a From email address for your notification.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<input class="wpabstracts form-control" name="admin_from_email" type="text" value="<?php echo $settings->admin_from_email; ?>" />
						</div>

						<div class="wpabstracts form-group col-xs-12 col-md-4">
							<label class="wpabstracts control-label"><?php _e('Email Subject', 'wpabstracts'); ?></label>
							<span class="settings_tip" data-tip="<?php _e('Enter the subject for the email sent to admins when a user registers.', 'wpabstracts'); ?>">
								<i class="wpabstracts text-info glyphicon glyphicon-question-sign"></i>
							</span>
							<input class="wpabstracts form-control" name="admin_email_subject" type="text" value="<?php echo $settings->admin_email_subject; ?>" />
						</div>

						<div class="wpabstracts form-group col-xs-12 col-md-8">
							<?php
							$cmSettings = array( 'media_buttons' => false, 'textarea_name' => 'admin_reg_email', 'wpautop'=>true, 'dfw' => true, 'editor_height' => 180, 'quicktags' => true);
							wp_editor($settings->admin_reg_email, 'admin_reg_email', $cmSettings);
							?>
						</div>
